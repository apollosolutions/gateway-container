...
EXPECTED='{"errors":[{"message":"client identification headers (my-client-name, apollographql-client-version) not provided","extensions":{"code":"CLIENT_IDENTIFIERS_MISSING"}}]}'
